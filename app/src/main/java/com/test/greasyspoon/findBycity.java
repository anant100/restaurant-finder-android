...
public class findBycity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_find_bycity);

        Intent intent=getIntent();
        final  String SelectedCityname=intent.getStringExtra("City");

        helper = new Sqlitehelper(findBycity.this);
        db = helper.getReadableDatabase();

        SessionManager session=new SessionManager(findBycity.this,"");
        String mail=session.getsessiontitle();

        try {


            String squery = "select * from RestaurantDetails where R_City='"+SelectedCityname+"'";
            ...
            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view,
                    ...
                    if (c != null) {
                        ...
                        Intent i=new Intent(findBycity.this,show_mysearch.class);
        ...
        {
            Toast.makeText(findBycity.this, ""+e, Toast.LENGTH_LONG).show();
        ...
        imgHeader.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PopupMenu popup = new PopupMenu(findBycity.this,v);
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        if(item.getItemId()==R.id.fb)
                        {
                            ...
                            Toast.makeText(findBycity.this,"Give Your Feedback", Toast.LENGTH_LONG).show();
                        ...
                        else if(item.getItemId()== R.id.rt1)
                        {
                            ...
                            Toast.makeText(findBycity.this,"Give Your Rating plz", Toast.LENGTH_LONG).show();
                        ...
                        else if(item.getItemId()== R.id.bk1)
                        {
                            ...
                            {
                                Intent i=new Intent(findBycity.this,show_bookmark.class);
                                startActivity(i);
                            }
                            else
                            {

                                Intent i = new Intent(findBycity.this, Login.class);
                                startActivity(i);
                                Toast.makeText(findBycity.this, "Please Login to view your bookmark ..!!", Toast.LENGTH_LONG).show();
                            }
                        }
                        else if(item.getItemId()== R.id.sp)
                        {
                            ...
                            Toast.makeText(findBycity.this,"default", Toast.LENGTH_LONG).show();
                        }
