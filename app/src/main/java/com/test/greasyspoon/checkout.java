...
public class checkout extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtchkout=(TextView) findViewById(R.id.tvchkout);
        btnchkout=(Button)findViewById(R.id.btn_chkout);
       ...
       btnchkout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent c1=new Intent(checkout.this,payment.class);
                startActivity(c1);
            }
        });
        ...
        imgHeader.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PopupMenu popup = new PopupMenu(checkout.this,v);
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        if(item.getItemId()==R.id.fb)
                        {
                            ...
                            Toast.makeText(checkout.this,"Give Your Feedback", Toast.LENGTH_LONG).show();
                        ...
                        else if(item.getItemId()== R.id.rt1)
                        {
                            ...
                            Toast.makeText(checkout.this,"Give Your Rating plz", Toast.LENGTH_LONG).show();
                        ...
                        else if(item.getItemId()== R.id.bk1)
                        {
                            ...
                            Toast.makeText(checkout.this,"Your Bookmark", Toast.LENGTH_LONG).show();
                        ...
                        else if(item.getItemId()== R.id.sp)
                        {
                            ...
                            Toast.makeText(checkout.this,"default", Toast.LENGTH_LONG).show();
                        }
