...
public class searchBybudget extends AppCompatActivity {
    ImageView loc,home,feed,setting;
    EditText edt_budgetSearch;
    Button btn_budgetSearch;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_search_bybudget);
        ...
        edt_budgetSearch=(EditText)findViewById(R.id.edt_SearchBudget);
        btn_budgetSearch=(Button)findViewById(R.id.btn_BudgetSearch);

        btn_budgetSearch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                String Budget=edt_budgetSearch.getText().toString();



                Intent i=new Intent(searchBybudget.this,findBybudget.class);
                i.putExtra("Budget",Budget);
                Toast.makeText(searchBybudget.this, "Budget Selected is "+Budget, Toast.LENGTH_LONG).show();
                startActivity(i);
        ...
        imgHeader.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PopupMenu popup = new PopupMenu(searchBybudget.this,v);
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        if(item.getItemId()==R.id.fb)
                        {
                            ...
                            Toast.makeText(searchBybudget.this,"Give Your Feedback", Toast.LENGTH_LONG).show();
                        ...
                        else if(item.getItemId()== R.id.rt1)
                        {
                            ...
                            Toast.makeText(searchBybudget.this,"Give Your Rating plz", Toast.LENGTH_LONG).show();
                        ...
                        else if(item.getItemId()== R.id.bk1)
                        {
                            ...
                            Toast.makeText(searchBybudget.this,"Your Bookmark", Toast.LENGTH_LONG).show();
                        ...
                        else if(item.getItemId()== R.id.sp)
                        {
                            ...
                            Toast.makeText(searchBybudget.this,"default", Toast.LENGTH_LONG).show();
                        }
