...
public class findBycuisine extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_find_bycuisine);

        Intent intent=getIntent();
        final  String SelectedCuisinename=intent.getStringExtra("Cuisine");

        helper = new Sqlitehelper(findBycuisine.this);
        db = helper.getReadableDatabase();

        SessionManager session=new SessionManager(findBycuisine.this,"");
        String mail=session.getsessiontitle();

        try {


            String squery = "select * from RestaurantDetails where R_Cuisine='"+SelectedCuisinename+"'";
            ...
            while(c.moveToNext()){
                ...
                // String rcuisine = c.getString(c.getColumnIndex("R_Cuisine"));
                array.add(rname);
              //  array.add(rcuisine);
            }
            ...
            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view,
                    ...
                    if (c != null) {
                        ...
                        Intent i=new Intent(findBycuisine.this,show_mysearch.class);
        ...
        {
            Toast.makeText(findBycuisine.this, ""+e, Toast.LENGTH_LONG).show();
        ...
        imgHeader.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PopupMenu popup = new PopupMenu(findBycuisine.this,v);
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        if(item.getItemId()==R.id.fb)
                        {
                            ...
                            Toast.makeText(findBycuisine.this,"Give Your Feedback", Toast.LENGTH_LONG).show();
                        ...
                        else if(item.getItemId()== R.id.rt1)
                        {
                            ...
                            Toast.makeText(findBycuisine.this,"Give Your Rating plz", Toast.LENGTH_LONG).show();
                        ...
                        else if(item.getItemId()== R.id.bk1)
                        {
                            ...
                            {
                                Intent i=new Intent(findBycuisine.this,show_bookmark.class);
                                startActivity(i);
                            }
                            else
                            {

                                Intent i = new Intent(findBycuisine.this, Login.class);
                                startActivity(i);
                                Toast.makeText(findBycuisine.this, "Please Login to view your bookmark ..!!", Toast.LENGTH_LONG).show();
                            }
                        }
                        else if(item.getItemId()== R.id.sp)
                        {
                            ...
                            Toast.makeText(findBycuisine.this,"default", Toast.LENGTH_LONG).show();
                        }
