...
public class FeedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WebView wvfeedback=(WebView)findViewById(R.id.wbFeedback);

        wvfeedback.loadUrl("https://docs.google.com/forms/d/e/1FAIpQLSdQ--bPjcysoWeGTKnyBumjZd4MCgTUs_sWSfvnuufMn2_JGQ/viewform");

        final  SessionManager session =new SessionManager(FeedActivity.this,"");
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        if(item.getItemId()==R.id.fb)
                        {
                            ...
                            Toast.makeText(FeedActivity.this,"Give Your Feedback", Toast.LENGTH_LONG).show();
                        ...
                        else if(item.getItemId()== R.id.rt1)
                        {
                            ...
                            if(session.checkLoginhome())
                            {
                                Toast.makeText(FeedActivity.this,"Give Your Rating plz", Toast.LENGTH_LONG).show();
                            ...
                            else
                            {
                                ...
                                Intent i = new Intent(FeedActivity.this, Login.class);
                                startActivity(i);
                                Toast.makeText(FeedActivity.this, "Please Login to view your bookmark ..!!", Toast.LENGTH_LONG).show();
                            }
                        ...
                        else if(item.getItemId()== R.id.bk1)
                        {
                            ...
                            if(session.checkLoginhome())
                            {
                                Toast.makeText(FeedActivity.this,"Your Bookmark", Toast.LENGTH_LONG).show();
                                Intent i=new Intent(FeedActivity.this,show_bookmark.class);
                                startActivity(i);
                            }
                            else
                            {
                        ...
                        else if(item.getItemId()== R.id.sp)
                        {
                            ...
                            Toast.makeText(FeedActivity.this,"default", Toast.LENGTH_LONG).show();
                        }
